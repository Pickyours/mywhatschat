...
Route::middleware(['auth:user'])->group(function () {
    Route::prefix('/automation/flows')->group(function () {
        ...
        Route::put('/{flow}/publish', [Modules\FlowBuilder\Controllers\FlowController::class, 'publish']);    // Activate a flow
        Route::put('/{flow}/unpublish', [Modules\FlowBuilder\Controllers\FlowController::class, 'unpublish']);  // Deactivate a flow
    });
});
