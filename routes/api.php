...
Route::middleware([AuthenticateBearerToken::class])->group(function () {
    ...
    Route::get('/templates/{uuid}', [App\Http\Controllers\ApiController::class, 'getTemplateById']);
    Route::match(['get', 'post'], '/webhook/invoice-payment', [WebhookController::class, 'handleWebhook']);
    Route::post('/webhook/invoice-payment', [WebhookController::class, 'handleWebhook'])->withoutMiddleware(['auth:sanctum']);
});
